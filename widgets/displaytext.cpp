                                     ...
                                     QString const& currentBand, QString const& currentMode)
{
  ...
  //types.push_back (Highlight::CQ);     //avt 4/4/25
...
//avt 4/22/25 display a decode, can be a std msg or a F/H style msg
//                                   msg to display      std decode for dxCall & dxGrid
void DisplayText::displayDecodedText(QString displayMsg, DecodedText const& decodedText, QString const& myCall,
                                     QString const& mode,
                                     bool displayDXCCEntity, LogBook const& logBook,
                                     QString const& currentBand, bool ppfx, bool bCQonly, bool dim)   //avt 9/15/22
{
  bool for_us = false;    //avt 4/4/25
  ...
  QString dxCall = decodedText.deCall();      //avt 4//25
  QString dxGrid = decodedText.grid();      //avt 4//25
  QString message = displayMsg.left (displayMsg.indexOf (QChar::Nbsp)); // strip appended info
  if (!for_us)      //avt 4/4/25
    {
      if (displayDXCCEntity)
        {
          ...
          message = appendWorkedB4 (message, dxCall, dxGrid, &bg, &fg     //avt 4/4/25
  ...
  if (dim) fg = Qt::darkGray;   //avt 4/4/25
  appendText (message.trimmed (), bg, fg, decodedText.toCall(), dxCall);      //avt 4//25
}
