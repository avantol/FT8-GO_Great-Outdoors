...
public:
  ...
  QString lotw_pwd () const;      //avt 4/2/25
  QString park_id () const;      //avt 4/24/25
  QString Field_Day_Exchange() const;
  QString RTTY_Exchange() const;
  void setEU_VHF_Contest();
  void setSpecOpPota();      //avt 4/24/25
  void setSpecOpNone();      //avt 4/24/25
  ...
  enum class SpecialOperatingActivity {NONE, NA_VHF, EU_VHF, FIELD_DAY, RTTY, POTA, INVALID};
